...
function inversion() {
	...
	años = parseInt(prompt("Ingrese la cantidad de años en el cual desea analizar las ganancias"));

	interes = (dinero/100) * 2;
	meses = interes * 12;
	inversion = meses * años;


	alert("Esta es la ganancia que obtendra en " +años+ " años de " +inversion+ "");
